    ...
    <section className="py-20 bg-[#001f3f]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Time-Consuming */}
          <div className="group p-6 bg-white/10 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Time-Consuming</h3>
          ...
          <div className="group p-6 bg-white/10 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-4 group-hover:bg-white/30 transition-colors duration-300">
                <FaBalanceScale className="text-white text-2xl animate-bounce" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-white">Subjective</h3>
              <p className="text-gray-300">
          ...
          <div className="group p-6 bg-white/10 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-4 group-hover:bg-white/30 transition-colors duration-300">
                <FaMoneyBillWave className="text-white text-2xl animate-spin-slow" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-white">Costly</h3>
              <p className="text-gray-300">
